...
- 主要：运用了以深度学习和机器视觉技术为核心的“图像搜索”服务中的“商品图片搜索”功能——用户输入图片在商品图像库中搜索，找到所需商品的相关信息。即输入——商品实物图片，输出——同款/相关性大的商品信息。

- 次要：运用了同为“商品图片搜索”中的“商品推荐”功能——用户输入图片在商品图像库中搜索，可推荐同款或相似商品的图片。即输入——商品图片，输出——同款/相似商品信息。
