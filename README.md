...
### （一）加值宣言
*** 
- 如今，人们的文化需求逐渐上升。越来越多人喜欢到博物馆里进行参观，以作消遣、拓宽视野。在博物馆内，博物馆参观者可以购买纪念品或文创产品。但博物馆商品的出售方式还是以“人工售卖”为主，整个购物流程还是比较传统的，参观者并不能方便快捷地完成购物。基于现状，我们将采用“百度AI——商品图片搜索API”来对博物馆纪念品店进行加值。
